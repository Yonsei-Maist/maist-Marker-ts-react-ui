...
class BasicDrawer<T extends BaseMark> {
     ...
     * @returns 
     */
    loadSaveData(type: new() => T, saveData: LabelFormat | string) {
        if (typeof saveData === "string")
            return BaseMark.fillFromJSON<T>(type, saveData);
        else {
            return BaseMark.fillFromLabelFormat<T>(type, saveData);
        }
    }

    createMark(saveData: LabelFormat | string, toolType: string, memo?: string) {
        return {} as T;
    }
    ...
    createSaveData(map: Map, mark: BaseMark, fitPoint: boolean = true): LabelFormat {
