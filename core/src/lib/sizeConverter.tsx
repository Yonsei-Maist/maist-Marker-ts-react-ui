...
import { MAP_SIZE } from "../constants/tag";
...
export function fitPoints(width: number, height: number, points: number[], to_ratio?: boolean, fit: boolean = true) {
    ...
    if (!fit) {
        return points.map((o, i) => {
            ...
            return to_ratio ? o / MAP_SIZE * factor : o * MAP_SIZE / factor;
        })
    }
